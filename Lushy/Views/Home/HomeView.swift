...
struct HomeView: View {
    ...
    @Binding var selectedTab: Tab // <-- Use the now-global Tab enum
                ...
                VStack(spacing: 25) {
                    ...
                    HStack {
                        Text("My Beauty Bag")
                            ...
                            .shadow(color: .lushyPink.opacity(0.12), radius: 2, x: 0, y: 2)
                    ...
                    if viewModel.openProducts.isEmpty && viewModel.expiringProducts.isEmpty && viewModel.storedProducts.isEmpty {
                        VStack(spacing: 20) {
                            ...
                            Button(action: { selectedTab = .scan }) { // Use the correct tab enum value for Scan
                                Text("Start Scanning")
                                    .padding()
                                    .frame(width: 200)
